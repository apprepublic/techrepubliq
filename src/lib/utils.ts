...
export const services: Service[] = [
  ...
  },
  {
    ...
    hero: "A mobile product your customers can actually install — built once, priced once.",
    startingPrice: 5000,
    features: [
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "AI feature add-ons are a flat monthly fee (baseline $25/month at Startup, with 1,000 tokens), scaled by tier. They are not a token meter on the core build.",
      },
      {
...
export const projectTiers = [
  { name: "MVP", for: "Solo / small team", revisions: "3 pre-launch reviews", services: "Standard add-ons from $5/mo" },
  { name: "Startup", for: "Funded startup", revisions: "5 pre-launch reviews", services: "Baseline add-ons from $25/mo" },
  { name: "Business", for: "Established business", revisions: "10 pre-launch reviews", services: "Add-ons from $50/mo" },
