    ...
    <>
      ...
      <header className={`nav ${scrolled ? "scrolled" : ""}`} id="rootNav" data-theme={theme}>
          ...
          <nav aria-label="Primary">
            <ul className="nav-links">
              {links.map((l) => {
                ...
                const activeClass = (l.href === "/about" ? isAboutActive : l.href === "/services" ? isServicesActive : l.href === "/" ? isHomeActive : false) ? "active" : "";
        ...
        <div className={`mobile-menu ${open ? "visible" : "hidden"}`}>
          {links.map((l) => {
            const active = l.href === "/about" ? pathname === "/about" : l.href === "/services" ? pathname.startsWith("/services") : l.href === "/" ? pathname === "/" : false;
            if (l.href.startsWith("/#")) {
              return (
                <a
                  key={l.label}
